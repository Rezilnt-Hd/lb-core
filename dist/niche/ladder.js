...
export const KEYWORD_QUALIFIERS = ['company', 'services', 'contractor', 'companies'];
/** Intent prefixes: "<prefix> <niche> <city>" (e.g. "best landscaping dallas"). */
export const KEYWORD_INTENT_PREFIX = ['best', 'top'];
/** Intent suffixes: "<niche> <suffix> <city>" (e.g. "landscaping quotes dallas"). */
export const KEYWORD_INTENT_SUFFIX = ['quotes', 'estimates'];
