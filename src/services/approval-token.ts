...
export function _resetApprovalSecretCacheForTests(): void {
 ...
 */
export async function getApprovalSecret(): Promise<string> {
 ...
 */
export function signApprovalToken(secret: string, components: string[]): string {
 ...
 */
export function verifyApprovalToken(secret: string, components: string[], token: string): boolean {
